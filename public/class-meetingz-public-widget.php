 ...
 */
class Meetingz_Public_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array(
				...
				'description'                 => __( 'Displays a MeetingZ login form.', 'meetingz' ),
	...
	public function widget( $args, $instance ) {
		...
		echo Meetingz_Tokens_Helper::join_form_from_tokens_string( $display_helper, $tokens_string, $author );
	...
	public function form( $instance ) {
		...
		include 'partials/meetingz-create-widget-display.php';
	}
